package com.micro.pet.config.openapi;
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .description("""
                                RESTful API для управління тваринами та їх типами.
                                
                                ## Основні можливості:
                                - CRUD операції для тварин
                                - CRUD операції для типів тварин
                                - Детальна інформація у JSONB форматі
