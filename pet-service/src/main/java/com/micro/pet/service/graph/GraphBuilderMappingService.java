package com.micro.pet.service.graph;
...
public class GraphBuilderMappingService {
     ...
     * @param attributes attributes to load (e.g., {@link PetEntityGraphConstants#TYPE}, {@link PetEntityGraphConstants#INFO})
    ...
    public <T> EntityGraph getGraphWithAttributes(Class<T> entityClass, String... attributes) {
        ...
        for (String attribute : attributes) {
            // Support nested attributes (e.g., "info.pet")
